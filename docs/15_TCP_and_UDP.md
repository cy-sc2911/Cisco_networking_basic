...
Below are some common well-known port numbers and their associated applications.
...
| UDP/TCP | 53 | Domain Name Service (DNS) |
| UDP | 67 | Dynamic Host Configuration Protocol (DHCP) - Server |
| UDP | 68 | DHCP - Client |
