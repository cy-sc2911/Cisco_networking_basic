...
Bluetooth technology provides a simple way for mobile devices to connect to each other and to wireless accessories. Bluetooth is wireless, automatic, and use very little power which helps conserve battery life. Up to eight Bluetooth devices can be connected together at any one time.

**Examples of how devices use Bluetooth**

Hands-free headset - small earpiece with a microphone can be used for making and receiving calls.
...
Mobile speaker - Portable speakers can connect to a mobile device to provide high-quality audio without a stereo system.
