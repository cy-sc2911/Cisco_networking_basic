...
## Configuration Summary
    ...
    In the Simulation Panel, the filters are changed to only TCP and HTTP protocols.
    Next, Complex PDU was created. The destination IP address of ciscolearn.web.com is 172.16.15.200. The starting port is set to 1000, as shown in the image below.
