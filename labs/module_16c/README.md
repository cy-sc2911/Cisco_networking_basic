...
## Configuration Summary
    ...
    Step 4: Download a file from the FTP server
        ...
        In the prompt enter 'dir' again to verify the FTP file has been downloaded.
            Below are the image and the output:
                C:\>dir
                Volume in drive C has no label.
                Volume Serial Number is 5E12-4AF3
                Directory of C:\
    ...
    Step 5:
        ...
        To delete the file, enter the command 'delete sampleFile_FTP.txt'.
            Below are the image and output:
                C:\>ftp 209.165.200.226
                Trying to connect...209.165.200.226
                Connected to 209.165.200.226
                220- Welcome to PT Ftp server
        ...
        Enter the command 'dir' again to verify the file is deleted.
            Below is the output:
                ftp>dir
